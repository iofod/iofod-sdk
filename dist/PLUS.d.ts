...
export type IHelperBaseType = boolean | string | number;
export interface IModelBaseConf {
	type: string;
	use: string;
	default: IHelperBaseType;
}
export interface IHelperSelectConf extends IModelBaseConf {
	options: IHelperBaseType[];
	labels: string[];
	filterable?: boolean;
}
export interface IHelperSliderConf extends IModelBaseConf {
	range: number[];
	step: number;
}
...
export interface IModelTooltipConf {
	type: string;
	i18n: I18nConf;
}
...
```
*/
export declare function registerModelHelper(payload: IModelHelper): Promise<IRes>;
/**
...
```
*/
export declare function registerModelTooltip(payload: IModelTooltip): Promise<IRes>;
/**
