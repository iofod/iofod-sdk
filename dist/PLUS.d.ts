...
*/
export declare function on(event: string, fn?: Function): void;
/**
...
export type IMatchCof = string | boolean | IContainer | IText | ITab | IButton | IButtonGroup | ISwitchItem | ICheckbox | ISelectItem | IInputItem | ICanvas | ISliderItem | ISubHeader | IHeader | ILoading | ILink | IImage | ITextarea | IUploadItem | IIFstructContainer | ICode;
